...
| Integrated stack | PR-PATCH-001 + PR-PATCH-002 + PR-PATCH-003 + PR-PATCH-004 + PR-PATCH-005 + PR-PATCH-006 + PR-PATCH-007 + PR-PATCH-015 |
| Latest local PR-PATCH commit | `628a81c PR-PATCH-007: add memory provider lifecycle` |
| Latest fork integration commit | `1a4e23f merge: integrate PR07 into fork hermes portage` |
